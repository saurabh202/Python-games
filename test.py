...
# caption and icon
pygame.display.set_caption("Welcome to Space Shooter!!")
...
for num in range(no_of_invaders):
	invaderImage.append(pygame.image.load('pics/ufo.png'))
	invader_X.append(random.randint(128, 737))
	invader_Y.append(random.randint(90, 180))
...
def player(x, y):
	screen.blit(playerImage, (x - 4, y + 4))
